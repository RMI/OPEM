...
class PipelineEF:
    ...
    # CALCULATED
    pipeline_emission_factors: DefaultDict = field(default_factory=lambda: {"Transport Emission Factors by Process Fuel(g CO2eq. per kgkm)": {
        "Pipeline Turbine": {
            "NG": None,	"Diesel": None,	"Electricity": None,	"Residual Oil": None,	"LPG": None,	"DME": None,	"FTD": None,	"Biodiesel": None,	"Renewable Diesel": None,	"Renewable Gasoline": None,	"Hydrogen": None},
